  ...
  <layout>
    <div class="articleCreate-container">
      ...
      <el-form class="form-article" ref="form" :model="article"
        ...
        <el-form-item>
          <el-button type="primary" @click="articleEdit">保存</el-button>
...
export default {
  ...
  created() {
    ...
    articleModel.articleShowItem(id).then((res) => {
  ...
  methods: {
    ...
    articleEdit() {
      ...
      articleModel.articleEdit(id, { title, classify_id, comment }).then(() => {
